...
public class RegisterTutorGUI extends JFrame {
    ...
    // ----------------------- GUI Constructor ------------------------
    public RegisterTutorGUI(String adminId) {
        setTitle("Register New Tutor"); // Set window title
    ...
    private void registerTutor() {
        ...
        String newId = Util.IdGenerator.getNewId(Tutor.class);
        AdminService.registerTutor(username, password, phone, email, country);

        // Show success message and reset form
        messageLabel.setForeground(Color.GREEN);
        messageLabel.setText("Tutor registered successfully! New ID is " + newId + ".");
        clearForm();
    }
