...
public class AdminMainGUI extends JFrame {    
    // Initialize GUI
    public AdminMainGUI(String adminId) {
        ...
        Admin targetAdmin = adminManager.getRecordById(adminId);
        JLabel welcomeLabel = new JLabel("Welcome " + targetAdmin.getUsername(), SwingConstants.CENTER);
        ...
        centerWrapper.setBackground(new Color(0, 128, 128));
        ...
        // defult icon picture
        String[] defaultIcons = {
            "/images/Tutor Account Management 1.png",    
            "/images/Tutor Subject Management 1.png",
            "/images/Receptionist Account Management 1.png",
            "/images/Fee 1.png"
        };
        
        // hoven icon picture
        String[] hoverIcons = {
            "/images/Tutor Account Management 2.png",    
            "/images/Tutor Subject Management 2.png",
            "/images/Receptionist Account Management 2.png",
            "/images/Fee 2.png"
        };
        

        // create 4 button at center
